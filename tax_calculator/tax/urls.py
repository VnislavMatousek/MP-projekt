...
urlpatterns = [
    ...
    path('delete_monthly_result/<int:result_id>/', views.delete_monthly_result, name='delete_monthly_result'),
    path('delete_yearly_result/<int:result_id>/', views.delete_yearly_result, name='delete_yearly_result')
]
